...
namespace Jorjouto.AnimComposerSystem.ACSEditor
{
    ...
    public partial class TimelineBar : VisualElement
    {
        ...
        /// <summary>
        /// The previous frame registered for the animation.
        /// </summary>
        ...
        {
            if(currentFrame == previousFrame || currentFrame >= timelineBar.childCount)
            {
                return;
            }

            timelineBar[previousFrame].RemoveFromClassList("TimelineBarCurrentFrame");
            timelineBar[currentFrame].AddToClassList("TimelineBarCurrentFrame");
