...
namespace Jorjouto.AnimComposerSystem
{
    ...
    public class RuntimeAnimComposer
    {
        ...
        public void Tick(float deltaTime)
        {
            ...
            foreach (var actionBlock in ActionBlocks)
            {
                ...
                bool frameOverlapsBlock = CheckFrameOverlapsBlock(ElapsedTime, actionBlock);

                if (!actionInstance.IsActive)
                {
                    if(frameOverlapsBlock)
                    {
        ...
        {
            BlendOutTime = blendOutTime ?? BlendOutTime;
        ...
        /// <summary>
        /// Determines whether the current frame / time is overlapping the ActionBlock
        /// </summary>
        ...
        private bool CheckFrameOverlapsBlock(float currentElapsedTime, ActionBlockData block)
        {
            return  (currentElapsedTime >=  block.StartTime) &&
                    (currentElapsedTime < block.EndTime);
        }
    }
    ...
    public class ScriptableObject_AnimComposer : ScriptableObject
    {
        ...
        /// The custom curve used to control the blend-out progression.
        /// </summary>
        public AnimationCurve BlendOutCurve = AnimationCurve.Linear(0,0,1,1);
        ...
        /// <summary>
        /// Frame range for which to extract root motion curves
        /// </summary>
        public Vector2Int CurvesFrameRange;

        /// <summary>
        /// Whether to flip all values from the x curve
        /// </summary>
        public bool FlipXCurve;

        /// <summary>
        /// Whether to flip all values from the y curve
        /// </summary>
        public bool FlipYCurve;
        
        /// <summary>
        /// Whether to flip all values from the z curve
        /// </summary>
        public bool FlipZCurve;
