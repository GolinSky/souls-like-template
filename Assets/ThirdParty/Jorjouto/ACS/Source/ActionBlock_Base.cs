...
namespace Jorjouto.AnimComposerSystem
{
    ...
    public abstract class ActionBlock_Base
    {
        ...
        /// <summary
        /// The custom name assigned to this ActionBlock. If no name is assigned, will use default ActionBlock class name
        /// 
        [Tooltip("The custom name assigned to this ActionBlock. If no name is assigned, will use default ActionBlock class name")]
