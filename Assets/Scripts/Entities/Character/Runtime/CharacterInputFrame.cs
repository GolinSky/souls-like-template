...
{
    /// <summary>Represents raw local-control intent before action arbitration.</summary>
    public readonly struct CharacterInputFrame
    {
        ...
        public CharacterInputFrame(
            Vector2 moveInput, float cameraYaw,
            bool sprintHeld, bool rollRequested,
            bool crouchHeld, bool guardPressed, bool guardHeld,
            bool attackPressed, bool attackHeld, bool strongAttackPressed, bool strongAttackHeld,
