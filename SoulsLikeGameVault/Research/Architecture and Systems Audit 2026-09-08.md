...
| --- | ----------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | [[History/Closed Issues/Locked Roll State Is Cleared Before Root Motion]]               | Remains. `Assets/Scripts/Entities/Character/Character.cs:190`; `Assets/Scripts/Components/Movement/MovementComponent.cs:142,158`. Lock updates still clear metadata consumed by root motion.                                                                                                                                                                    |
| 2   | [[History/Closed Issues/Stance Recovery Is Gated By Poise Delay]]                       | Remains a code/documentation mismatch requiring a balance decision. `Assets/Scripts/Entities/Combat/CombatDefenseComponent.cs:223,238`. Do not silently change the intended recovery rule.                                                                                                                                                                      |
| 3   | [[History/Closed Issues/Inventory Category Controls Are Not Connected]]                 | Remains. `Assets/Scripts/Ui/Inventory/InventoryUiController.cs:85` has presenter operations without corresponding view category wiring; `Assets/Prefabs/Ui/Inventory/InventoryUi.prefab` assigns both category containers to the same template RectTransform.                                                                                                   |
...
| 5   | [[Work/Issues/Rejected Scene Transition Can Overwrite Pending Spawn Intent]]            | Remains. `Assets/Scripts/Services/Scenes/SceneService.cs:45,69` has no in-flight gate. Extended by A3 below; do not create a second concurrency issue.                                                                                                                                                                                                          |
...
[[History/Closed Issues/Character Lifecycle Can Stall When Animation Notifications Are Missing]]
...
[[History/Closed Issues/Animation Completion Is Not Correlated To The Owning Action]]
