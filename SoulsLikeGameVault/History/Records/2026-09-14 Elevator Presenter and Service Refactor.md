...
`AGENTS.md` now prohibits project-authored gameplay/presentation UnityEvents and states presenter/service ownership. [[Knowledge/Architecture/Systems/Elevator System]] describes the current registration, camera, and rider routes.
