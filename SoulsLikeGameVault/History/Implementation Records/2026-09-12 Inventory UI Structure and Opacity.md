...
- Values are chosen design defaults based on [[Guides/UI/Dark Fantasy UI Style and Asset Rules]], not recovered Elden Ring settings.
...
Penpot design notes and this record. The supplied rule guides and required AGENTS routing were registered in [[2026-09-12 UI Rule Guides Registered]].

### Follow-Up

During implementation, use [[Guides/UI/Unity UI Asset Layout and Troubleshooting Rules]] to keep body, content, effects, and hit bounds independent, and validate the composite in the target Unity rendering path.
