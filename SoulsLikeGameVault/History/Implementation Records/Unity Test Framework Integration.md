...
Unity Test Framework (UTF) 1.6.0 is an explicit project dependency. Agents now route Unity test work through the registered [[Guides/Testing/Unity Test Framework Test Flow|Unity Test Framework Test Flow]] using the existing official Unity CLI/Pipeline bridge.
...
- [[Guides/Testing/Unity Test Framework Test Flow]]
- [[Agent Guide/Agent Context Registry]]: required `unity-testing` context.
