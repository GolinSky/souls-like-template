...
In [`Character.cs`](../../../Assets/Scripts/Entities/Character/Character.cs#L158-L187):
```csharp
...
However, in [`Character.StartRoll()`](../../../Assets/Scripts/Entities/Character/Character.cs#L347-L372):
```csharp
...
**File:** [`Assets/Art/Animation/CharacterGreatSwordAnimator.controller`](../../../Assets/Art/Animation/CharacterGreatSwordAnimator.controller)
...
- Script: [`AnimatorStateMachine.cs`](../../../Assets/Scripts/Components/Animations/AnimatorStateMachine.cs)
...
**File:** [`Assets/Scripts/Components/Animator/AnimatorRootMotionRelay.cs`](../../../Assets/Scripts/Components/Animator/AnimatorRootMotionRelay.cs)
...
#### 1. Input Generation: [`PlayerInputReader.cs`](../../../Assets/Scripts/Entities/Character/Input/PlayerInputReader.cs)
...
#### 2. Dispatch: [`Character.cs`](../../../Assets/Scripts/Entities/Character/Character.cs)
In `Character.Tick()`:
```csharp
...
#### 3. State Machine Interception: [`CharacterActionStateMachine.cs`](../../../Assets/Scripts/Entities/Character/Runtime/CharacterActionStateMachine.cs)
```csharp
...
| Stage | Animator state | Action-state-machine state | Failure mechanism |
|---|---|---|---|
| Roll 1 | Normal roll reaches its queue window. | `Roll`, then queue opens. | None. |
| Roll 2 | A self-transition starts while the previous state info is still visible. | Chained `Roll`; the next exit is ignored. | `QueueCheck` fires prematurely from the old normalized time, then the old exit closes the queue again. |
| Roll 3 | Another transition overlaps the pending exits. | Chained `Roll`; ignore state is overwritten or consumed. | The state behaviour has already fired its queue check, so the real window does not reopen. |
| Roll 4 | The character is visibly still rolling. | An overlapping exit incorrectly returns the action state to `Neutral`. | A new roll is treated as non-interrupting, movement reports `TemporarilyBlocked`, and the action buffers until the animation finishes. |

This stage table replaces the previous 42-message sequence diagram, which was wider than a normal Obsidian pane. The empirical evidence and frame-level explanation below remain the detailed source.
...
**File:** [`Assets/Scripts/Components/Animations/AnimatorStateMachine.cs`](../../../Assets/Scripts/Components/Animations/AnimatorStateMachine.cs)
...
**File:** [`Assets/Scripts/Entities/Character/Runtime/CharacterActionStateMachine.cs`](../../../Assets/Scripts/Entities/Character/Runtime/CharacterActionStateMachine.cs)
...
**File:** [`Assets/Scripts/Entities/Character/Character.cs`](../../../Assets/Scripts/Entities/Character/Character.cs)
...
- **Primary C# Scripts Under Review:**
  - [`Assets/Scripts/Entities/Character/Runtime/CharacterActionStateMachine.cs`](../../../Assets/Scripts/Entities/Character/Runtime/CharacterActionStateMachine.cs)
  - [`Assets/Scripts/Components/Animations/AnimatorStateMachine.cs`](../../../Assets/Scripts/Components/Animations/AnimatorStateMachine.cs)
  - [`Assets/Scripts/Components/Animations/AnimatorStateMachineReceiver.cs`](../../../Assets/Scripts/Components/Animations/AnimatorStateMachineReceiver.cs)
  - [`Assets/Scripts/Entities/Character/Character.cs`](../../../Assets/Scripts/Entities/Character/Character.cs)
  - [`Assets/Scripts/Entities/Character/Input/PlayerInputReader.cs`](../../../Assets/Scripts/Entities/Character/Input/PlayerInputReader.cs)
  - [`Assets/Scripts/Components/Movement/MovementComponent.cs`](../../../Assets/Scripts/Components/Movement/MovementComponent.cs)
  - [`Assets/Scripts/Components/Animator/AnimatorRootMotionRelay.cs`](../../../Assets/Scripts/Components/Animator/AnimatorRootMotionRelay.cs)
- **Primary Serialized Assets Under Review:**
  - [`Assets/Art/Animation/CharacterGreatSwordAnimator.controller`](../../../Assets/Art/Animation/CharacterGreatSwordAnimator.controller)
  - [`Assets/Settings/Player/MovementData.asset`](../../../Assets/Settings/Player/MovementData.asset)
  - [`Assets/Settings/Data/HealthData.asset`](../../../Assets/Settings/Data/HealthData.asset)
  - [`Assets/Prefabs/Models/Character/Character.prefab`](../../../Assets/Prefabs/Models/Character/Character.prefab)
- **Skill Context Reference:**
  - Vault Guide: [[Knowledge/Guides/Animation/Animator Sub-State Machine Guide]]
  - Registry Key: `animation-code` in [[Meta/Agent Context Registry]]
