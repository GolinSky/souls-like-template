...
Completed on 2026-09-14: locator signatures and links were corrected, the roll findings were closed, and interaction/roll audit statements are explicitly historical. This is documentation reconciliation; it makes no new runtime claim.
...
- SoulsLikeGameVault/History/Closed Issues/Roll Interruption Issue.md — Fix 3 and Fix 4 propose out-of-combat stamina gating and animation-lock interruption support.
- Assets/Scripts/Entities/Character/Character.cs:370-401 — those two proposed changes are already implemented.
- SoulsLikeGameVault/Knowledge/Architecture/Systems/Entity Locator System.md:37-48 vs Assets/Scripts/Entities/BaseEntity/IEntityLocator.cs — documented unsigned ID differs from current signed ID API.
...
Related: [[Meta/Agent Context Registry]], [[Research/Interaction System Audit]], [[History/Closed Issues/Roll Interruption Issue]], [[Knowledge/Architecture/Systems/Entity Locator System]].
