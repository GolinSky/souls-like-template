...
`Main Menu or Pause/System Menu -> SettingsUiController <-> SettingsUi`

`SettingsUiController -> SettingsService <-> ISaveService`

`SettingsService -> AudioService / CameraService / InputService / GraphicsSettingsApplier / PresentationSettingsApplier`

The responsibility table below is the authoritative ownership view; it avoids hiding important boundaries inside a wide graph.
