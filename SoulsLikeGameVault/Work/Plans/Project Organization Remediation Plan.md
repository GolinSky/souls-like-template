---
title: Project Organization Remediation Plan
type: plan
domains:
  - project-structure
  - assets
...
updated: 2026-09-07
aliases:
  - Project_Organization_Analysis_And_Fix_Plan
tags:
  - work/plan
  - status/draft
---
...
```text
Current Assets/Prefabs/              Expected Assets/Prefabs/
├── Camera/                          ├── Models/
├── Character/                       │   ├── Character/
├── Enemy/                           │   ├── Enemy/
├── Grace/                           │   ├── Equipment/
├── Item/                            │   ├── Items/
├── Shields/ and Swords/             │   └── Environment/
├── VContainer/                      ├── View/
└── Ui/                              │   ├── Camera/
    └── UiService.prefab             │   ├── Services/
                                      │   └── VContainer/
                                      └── Ui/
                                          ├── Screens and HUD
...
2. **`Assets/Art/Reference/`**:
   ...
   - *Recommendation*: Relocate project documentation to the appropriate current vault section or place art references under `Assets/Sandbox/Art/Reference/`.
