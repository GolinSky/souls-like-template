---
title: Animator Sub-State Machine Guide
type: guide
domains:
  - animation
status: current
...
context_keys:
  - animation-code
aliases:
  - Animator_SubState_Machine_Architecture_Guide
tags:
  - agent/context
---
...
> The workflow rules remain required. Runtime integration is present in `AnimatorComponent`, but layout claims must be checked against the affected `.controller` assets during each Animator task.
