...
description: Technical system specification for 3rd-person character locomotion,
  Cinemachine 3 camera controller, and targeting service in SoulsLikeTemplate.
version: 2.0.0
title: Locomotion and Camera
type: game-design
domains:
  - movement
  - camera
...
- **`CameraService`** ([`Assets/Scripts/Services/CameraService/CameraService.cs`](../../../Assets/Scripts/Services/CameraService/CameraService.cs)): Manages Cinemachine 3 virtual cameras, rig blending, look pitch/yaw, vertical follow smoothing with airborne lag, and target look-at tracking.
- **`TargetingService`** ([`Assets/Scripts/Services/Targeting/TargetingService.cs`](../../../Assets/Scripts/Services/Targeting/TargetingService.cs)): Manages spatial target acquisition and validity checking across `EntityType.Enemy` actors within $20.0\text{m}$.
- **`MovementComponent`** ([`Assets/Scripts/Components/Movement/MovementComponent.cs`](../../../Assets/Scripts/Components/Movement/MovementComponent.cs)): Governs motor physics, ground probing, directional facing, and speed scaling in both `Free` and `LockedOn` modes.
...
To keep jumping and landing readable without jarring camera snaps, [`CameraService.UpdateFollowTarget`](../../../Assets/Scripts/Services/CameraService/CameraService.cs) implements vertical lag filtering:
...
1. [`PlayerController.HandleLockOnInput`](../../../Assets/Scripts/Entities/Character/PlayerController.cs) invokes [`TargetingService.TryAcquireTarget`](../../../Assets/Scripts/Services/Targeting/TargetingService.cs).
