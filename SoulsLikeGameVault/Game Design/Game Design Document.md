...
- [[Game Design/Mechanics/Movement Mechanics|Movement Mechanics]] — explanatory feature note; verify tuning values before treating them as current.
- [[Game Design/Systems/Locomotion and Camera|Locomotion and Camera]] — proposed behavior specification.
- [[Game Design/Technical Specifications/Locomotion Architecture|Locomotion Architecture]] — proposed technical design, not implementation authority.
- [[Game Design/Technical Specifications/Roll and Backstep Vectoring|Roll and Backstep Vectoring]] — proposed detailed behavior.

### Combat and Enemies

- [[Game Design/Systems/Enemy Combat and AI|Enemy Combat and AI]] — current design/reference candidate.

### UI and Equipment

- [[../Guides/UI/Inventory UI and UX Guide|Inventory UI and UX Guide]]
- [[../Guides/UI/Equipment UI and UX Guide|Equipment UI and UX Guide]]
...
- New features use [[../Templates/Game Design Feature Template|Game Design Feature Template]].
