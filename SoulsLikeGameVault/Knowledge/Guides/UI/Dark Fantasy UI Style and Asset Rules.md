...
companion: "[[Knowledge/Guides/UI/Unity UI Asset Layout and Troubleshooting Rules]]"
tags:
  - agent/context
---
...
- Existing [[Meta/Vault Guide|vault workflow]], `AGENTS.md`, the official Unity CLI workflow, Unity clean-scene safeguards, and the project's no-normal-Play-Mode-validation rule outrank examples in the source specification.
