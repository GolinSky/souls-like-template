...
description: System prompt specification and mathematical reference for
  Souls-like character locomotion architecture, with implementation mapping to
  SoulsLikeTemplate C# systems.
version: 2.0.0
title: Advanced Locomotion Prompt Specification
type: archive
domains:
  - movement
  - locomotion
